...
<head>
  ...
  <title>IIIT Bhubaneswar Student e-pass - Home</title>
...
<body>
 ...
 <?php include_once('includes/header.php');?>
  ...
  <section class="hero-banner text-center">
    <div class="container">
      <h1> IIIT Bhubaneswar's Student e-pass System </h1>
      <h2> please login or Register yourself  </h2>
      <h3> If already  registered then put the registration Id below </h3> 
    </div>
  </section>
  <!--================ Banner Section end =================-->
